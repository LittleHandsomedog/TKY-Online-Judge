  ...
  <div>
    <div class="intr-center">
      <paper-card type="server">
        <h1 class="text-darken">TKYOJ</h1>
        <h1>
          <a href="https://github.com/LittleHandsomedog/TKY-Online-Judge" target="_blank"
            >TKY Online Judge</a
          >
        </h1>
        <p>
          {{ $t('m.Leader_BackEnd_FrontEnd_Engineer') }} / Handsomedog
          <a href="https://github.com/LittleHandsomedog" class="icon" target="_blank"
            ><i class="fa fa-github"></i>
          </a>
        </p>
        <p>
          {{ $t('m.Group_Function_Development_Contributor') }} / 王老师 伍老师
